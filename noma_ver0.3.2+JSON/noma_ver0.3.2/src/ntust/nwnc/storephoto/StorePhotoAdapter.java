...
public class StorePhotoAdapter extends BaseAdapter {
	...
	public StorePhotoAdapter(StorePhotoActivity context,List<String> listItems){
	...
	public View getView(int position, View convertView, ViewGroup parent) {	
		...
		View rowView = inflater.inflate(R.layout.photo_store_cell, null);
