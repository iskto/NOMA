...
public class StoreJSONData{
	...
	public StoreJSONData(SharePagerActivity context){
		url="http://192.168.1.103:26080/store/";	//伺服器的IP位址
	...
	public int getPrice(int id){		
		int Price;
		try{
			Price= (int) jsonarray.getJSONObject(id).get("Price");
		}catch(Exception e){
			Price= -1;
		}
		return Price;
	...
	public String getLoc(int id){		
		String Loc;
		try{
			Loc= (String) jsonarray.getJSONObject(id).get("Loc");
		}catch(Exception e){
			Loc= null;
		}
		return Loc;
	...
	public void putJSONObject(String Title,int Price,String Img,int Star,String Desc,String Loc,int Rating){	
		...
		try{
			...
			jsonobject.put("id", String.valueOf(jsonarray.length()+1));
			//Log.i("id",String.valueOf(jsonarray.length()+1));
	...
	public void putJSONObject(String Title,int Price,byte[] ImgByte,int Star,String Desc,String Loc,int Rating){	
		ImgByte=compressImgByte(ImgByte);
		String Img=Base64.encodeToString(ImgByte, Base64.DEFAULT);
		this.putJSONObject(Title,Price, Img, Star, Desc,Loc, Rating);
		
	}
	
	public void putJSONObject(String Title,int Price,InputStream ImgInputStream,int Star,String Desc,String Loc,int Rating){
		this.Title=Title;
		this.Price=Price;
	...
	public void putJSONObjectByImgURL(String Title,int Price,String ImgUrl,int Star,String Desc,String Loc,int Rating){	
		this.Title=Title;
		this.Price=Price;
		this.imgUrl=ImgUrl;
		this.Star=Star;
